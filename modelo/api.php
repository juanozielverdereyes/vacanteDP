	...
	class api
	{
		...
		public function MetodoGet(){			
			try {
				...
				$Validar = new valida();
				$Valor = $ObjetoColor->ObtenerObjeto();/*valor se encontraba igualado a un array vacio*/
				//$valor = [];
				
				$Validar->CreaRespuesta("0", "Ok", $Valor);/* enviamos la información del array, el segundo valor lo ponen adelante con "ok" pero lo puedes llevar de una vez*/
